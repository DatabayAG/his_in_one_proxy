...
/**
 * Class EAddressTagTest
 */
class EAddressTagTest extends PHPUnit\Framework\TestCase
{

	/**
	 * @var DataModel\EAddressTag $instance
	 */
	protected $instance;

	protected function setUp()
	{
		$this->instance = new DataModel\EAddressTag();
	}

	public function test_instantiateObject_shouldReturnInstance()
	{
		$this->assertInstanceOf('HisInOneProxy\DataModel\EAddressTag', $this->instance);
	}
